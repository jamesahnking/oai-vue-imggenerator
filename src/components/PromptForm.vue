    ...
    <div class="flex flex-wrap shadow-2">
        ...
        <div class="w-full lg:w-6 p-4 lg:p-7 surface-card">
            ...
            <div class="flex align-items-center justify-content-between mb-4">
                <span class="text-md font-medium text-900">Describe an image in the prompt below then selecte its output size.</span>
                 
            </div>
            <label for="email4" class="block text-900 font-medium mb-2">Image Description</label>
            <InputText id="email4" v-model="prompt" type="text" class="w-full mb-3 p-3" placeholder="A dragon sipping a beer on a volcano" />
